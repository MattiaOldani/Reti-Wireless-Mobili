...
#align(center)[
  #image("assets/08/qos.png", width: 70%)
]
...
#align(center)[
  #image("assets/08/EDCA.png", width: 70%)
]
...
#align(center)[
  #image("assets/08/messaggi.png", width: 70%)
]
...
#align(center)[
  #image("assets/08/allontanamento.png", width: 70%)
]
...
#align(center)[
  #image("assets/08/ritrasmissione.png", width: 70%)
]
