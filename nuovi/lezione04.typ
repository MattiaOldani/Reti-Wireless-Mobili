...
#align(center)[
  #image("assets/04/architettura.png")
]
...
#align(center)[
  #image("assets/04/radio.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/scatternet.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/comunicazione.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/TDMA.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/canali.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/ACL.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/access_code.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/header.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/errori.png", width: 70%)
]
...
#align(center)[
  #image("assets/04/stati.png", width: 60%)
]
